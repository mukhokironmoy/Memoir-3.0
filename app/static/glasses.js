...
/* ============================
   CONFIG
============================ */
const RECOGNIZE_TARGET_PERSON_ID = 2; // <-- change this to 2, 3, ... when testing
const UNKNOWN_ID = 1; // must match the fixed id from your seed
...
document.addEventListener("click", async (e) => {
  ...
  switch (action) {
    ...
    case "start-conversation": {
      ...
      AppState.conversationId = Date.now();
  ...
  if (data.ok && data.match) {
    ...
    alert("I don’t recognize this face.");
    // later: optionally create an "unknown" profile automatically
  }
  break;
}
